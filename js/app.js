(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".townmenu__slider")) new core(".townmenu__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".food__slider")) new core(".food__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".corn__slider")) new core(".corn__slider", {
            modules: [ Navigation ],
            observer: false,
            observeParents: false,
            slidesPerView: 3,
        ...
        if (document.querySelector(".kitchen__slider")) new core(".kitchen__slider", {
            modules: [ Navigation, Pagination ],
            observer: false,
            observeParents: false,
            slidesPerView: 1,
        ...
        if (document.querySelector(".product-popup__slider")) new core(".product-popup__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            pagination: {
                el: ".product-popup__swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".product-popup__swiper-button-prev",
                nextEl: ".product-popup__swiper-button-next"
            },
            on: {}
        });
    }
    ...
    da.init();
    const script_plugin = {};
    script_plugin.popup = function(options) {
    ...
    const formPopup = script_plugin.popup(formOptions);
    let termsOptions = {
        close: "terms-close",
    ...
    const termsPopup = script_plugin.popup(termsOptions);
    let info = [ {
        img: "img/food/1.jpg",
        title: "Торт",
        price: "100г/ 5р",
    ...
    if (product) product.onclick = function(e) {
        let target = e.target;
        ...
        for (let img of images) img.src = newSrc;
    ...
    closeButton.addEventListener("click", (function() {
        script_layer.classList.remove("__active");
    ...
    if (guest) guest.addEventListener("click", formPopupOpener);
